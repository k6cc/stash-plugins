...
| 插件 | 版本 | 类型 | 说明 | 源码仓库 |
|------|------|------|------|---------|
| Binge | 0.8.5 | UI | Instagram 风格社交与发现层（汉化版） | [binge-cn](https://github.com/k6cc/binge-cn) |
...
| JavStashLinker | 1.5.7 | Python + UI | 批量匹配 JAVStash 演员 ID | [stash-jav-tools](https://github.com/k6cc/stash-jav-tools) |
...
| Studio Tools Auto | 1.1.1 | Python 任务 | 后台自动整理工作室（钩子 + 存量扫描） | [stash-jav-tools](https://github.com/k6cc/stash-jav-tools) |
