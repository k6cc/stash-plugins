...
| 插件 | 版本 | 类型 | 说明 | 源码仓库 |
|------|------|------|------|---------|
| Binge | 0.8.6 | UI | Instagram 风格社交与发现层（汉化版） | [binge-cn](https://github.com/k6cc/binge-cn) |
...
| Scene Translate Auto | 1.1.0 | Python 任务 | 后台自动翻译场景标题/简介（钩子 + 存量扫描） | [stash-jav-tools](https://github.com/k6cc/stash-jav-tools) |
