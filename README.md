...
| 插件 | 版本 | 类型 | 说明 | 源码仓库 |
|------|------|------|------|---------|
| Binge | 0.8.0 | UI | Instagram 风格社交与发现层（汉化版） | [binge-cn](https://github.com/k6cc/binge-cn) |
...
| Studio Tools | 1.5.1 | UI | 工作室合并与 StashDB 搜索 | [stash-jav-tools](https://github.com/k6cc/stash-jav-tools) |
